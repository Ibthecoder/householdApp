                    ...
                    <form action="LoginServlet" method="POST">
                        <div class="space-y-5">
                            ...
                            <div class="text-center">
                                <p class="text-base text-gray-600">Don’t have an account? <a href="registration.jsp" title="" class="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Create a free account</a></p>
                            </div>
                        </div>
                    </form>
                </div>
